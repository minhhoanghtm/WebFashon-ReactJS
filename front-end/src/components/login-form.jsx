...
export function LoginForm({
  ...
  const XIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5">
      <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24h-6.657l-5.207-6.807-5.974 6.807H2.882l7.432-8.491L1.227 2.25h6.836l4.713 6.231 5.45-6.231zM17.002 18.807h1.646L6.154 4.556H4.382l12.62 14.251z" fill="currentColor"/>
    </svg>
  )
  ...
  return (
    <div className={cn("flex flex-col gap-6 relative", className)} {...props}>
          ...
          <form className="p-6 md:p-8" onSubmit={handleSubmit}>
            <FieldGroup>
              ...
              <Field className="grid grid-cols-3 gap-4">
                <Button variant="outline" type="button" title="Đăng nhập với Google">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5">
                ...
                <Button variant="outline" type="button" title="Đăng nhập với Facebook">
                  <FacebookIcon />
              ...
              <FieldDescription className="text-center">
                Chưa có tài khoản? <a href="/register" className="font-semibold hover:underline">Đăng ký</a>
              </FieldDescription>
            </FieldGroup>
          </form>
      ...
      <FieldDescription className="px-6 text-center">
        Bằng cách tiếp tục, bạn đồng ý với <a href="#" className="hover:underline">Điều khoản dịch vụ</a>{" "}
        và <a href="#" className="hover:underline">Chính sách bảo mật</a> của chúng tôi.
      </FieldDescription>
    </div>
  )
}
